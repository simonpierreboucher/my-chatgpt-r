...
export default function History() {
  ...
  async function exportHistory() {
    try {
      ...
      alert(`Export successful: ${indices.length} records`);
    } catch (e) {
  ...
  async function importHistory(historyStr: string) {
    try {
      ...
      alert(
        `Import successful: ${history.length} records, imported ${added}${
    ...
    <div className="mt-5 flex h-screen flex-1 flex-col overflow-hidden">
      ...
      <div className="basis-30 flex w-full shrink-0 grow-0 items-center justify-center">
        <button
          ...
          title="Export all chat records to clipboard"
        ...
        <button
          className="flex grow items-center justify-center rounded-md p-2 text-indigo-300 hover:bg-indigo-600"
          title="Import chat records exported from elsewhere"
                      ...
                      <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-slate-500">
                            Are you sure you want to delete all chat records?
                          </p>
                        </div>
                      </div>
                    </div>
