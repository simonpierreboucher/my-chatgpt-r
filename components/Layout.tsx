              ...
              >
                <Menu.Items className="absolute right-0 z-10 w-48 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-slate-700">
                  <Menu.Item key="temperature" as="div" className="p-2">
                    ...
                    >
                      <span title="The temperature of the model affects the randomness of the results. The range is 0.0 to 2.0 (but responses become unreliable above 1.2). The lower the value, the more certain the model; the higher the value, the more random the model.">
