      ...
      <div className="flex h-[calc(100vh-150px)] flex-col justify-between gap-5">
        ...
        <div className="md-0 pd-0 flex flex-col items-center justify-center gap-2 md:flex-row">
          <textarea
            rows={3}
            name="input"
            placeholder="Enter here (Enter to submit, Shift+Enter for a new line)"
            value={input}
          ...
          <div className="margin-2 flex basis-1/5 items-center justify-center gap-2 ">
            <Button
              ...
              title="Send the current input to ChatGPT"
            ...
            <Button
              ...
              title="Copy the full content of the current conversation to the clipboard"
            >
              <ClipboardDocumentIcon
                className="h-6 text-indigo-300 hover:text-indigo-600 dark:text-slate-400 dark:hover:text-slate-100"
                aria-hidden="true"
            ...
            <Button
              ...
              className="lg:hidden"
              title="Start a new conversation (current conversation will be automatically saved)"
            >
              <ChatBubbleLeftRightIcon
                className="h-6 text-indigo-300 hover:text-indigo-600 dark:text-slate-400 dark:hover:text-slate-100"
                aria-hidden="true"
